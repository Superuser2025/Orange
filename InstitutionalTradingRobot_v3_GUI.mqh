...
void DrawPriceActionCommentary()
{
    ...
    int width = 900;  // Extra wide panel to ensure full educational commentary displays without any truncation
    int line_height = 20;
    ...
    for(int i = start_index; i < pa_commentary_count; i++)
    {
        ...
        // Wrap text into multiple lines if needed (120 chars per line for 900px panel)
        string wrapped_lines[];
        WrapText(display_text, wrapped_lines, 120);
